...
module cache (
    ...
    (* ram_style = "block" *)reg [32*(1 << OFFSET_WIDTH)-1:0] cache_memory_w1 [CACHE_DEPTH-1:0]; 
    (* ram_style = "block" *)reg [32*(1 << OFFSET_WIDTH)-1:0] cache_memory_w2 [CACHE_DEPTH-1:0]; 
    (* ram_style = "block" *)reg [32*(1 << OFFSET_WIDTH)-1:0] cache_memory_w3 [CACHE_DEPTH-1:0]; 
    ...
    logic valid_bits_w1 [CACHE_DEPTH-1:0];
    logic valid_bits_w2 [CACHE_DEPTH-1:0];
    logic valid_bits_w3 [CACHE_DEPTH-1:0];
    logic dirty_bits_w0 [CACHE_DEPTH-1:0];
    logic dirty_bits_w1 [CACHE_DEPTH-1:0];
    logic dirty_bits_w2 [CACHE_DEPTH-1:0];
    logic dirty_bits_w3 [CACHE_DEPTH-1:0];
