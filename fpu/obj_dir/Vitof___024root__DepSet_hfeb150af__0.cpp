...
VL_INLINE_OPT void Vitof___024root___nba_sequent__TOP__0(Vitof___024root* vlSelf) {
    ...
    if (vlSelf->rst_n) {
        vlSelf->out_f = ((0U == vlSelf->itof__DOT__s2_abs_i)
                          ? 0U : (((IData)(vlSelf->itof__DOT__s2_sign) 
                                   << 0x1fU) | (((IData)(vlSelf->itof__DOT__next_exp) 
                                                 << 0x17U) 
                                                | vlSelf->itof__DOT__next_frac)));
...
#endif
            VL_FATAL_MT("itof.sv", 3, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("itof.sv", 3, "", "Active region did not converge.");
            }
