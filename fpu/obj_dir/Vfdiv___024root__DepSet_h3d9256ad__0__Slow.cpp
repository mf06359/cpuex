...
VL_ATTR_COLD void Vfdiv___024root___ctor_var_reset(Vfdiv___024root* vlSelf) {
    ...
    vlSelf->fdiv__DOT__st1_exponent = VL_RAND_RESET_I(11);
    ...
    vlSelf->fdiv__DOT__st2_exp_minus1 = VL_RAND_RESET_I(11);
    vlSelf->fdiv__DOT__st2_exp_zero = VL_RAND_RESET_I(11);
    vlSelf->fdiv__DOT__st2_exp_plus1 = VL_RAND_RESET_I(11);
    vlSelf->fdiv__DOT__st2_mantissa = VL_RAND_RESET_I(24);
    vlSelf->fdiv__DOT__st2_x1 = VL_RAND_RESET_I(24);
    vlSelf->fdiv__DOT__q_final = VL_RAND_RESET_Q(48);
    vlSelf->fdiv__DOT__shift_sel = VL_RAND_RESET_I(2);
