...
VL_ATTR_COLD void Vfadd___024root___stl_sequent__TOP__0(Vfadd___024root* vlSelf) {
    ...
    fadd__DOT__c2_zlc = vlSelf->__Vfunc_fadd__DOT__count_leading_zeros__0__Vfuncout;
    ...
    if ((0x1bU <= (IData)(fadd__DOT__c1_diff))) {
        vlSelf->fadd__DOT__unnamedblk1__DOT__temp_shifted = 0U;
        vlSelf->fadd__DOT__c1_sticky = (0U != fadd__DOT__c1_mant_small);
    } else {
        vlSelf->fadd__DOT__unnamedblk1__DOT__temp_shifted 
    ...
    vlSelf->fadd__DOT__c1_exp_res = (0xffU & (vlSelf->fadd__DOT__c1_large 
                                              >> 0x17U));
    fadd__DOT__mant_final_shifted = (0xfffffffU & (vlSelf->fadd__DOT__s2_mant_reg 
                                                   << 
    ...
    if ((0U == (IData)(vlSelf->fadd__DOT__s2_exp_reg))) {
        vlSelf->fadd__DOT__frac_final = 0U;
        vlSelf->fadd__DOT__exp_final = 0U;
    } else if (fadd__DOT__round_up) {
        vlSelf->fadd__DOT__frac_rounded = (0xffffffU 
                                           & ((IData)(1U) 
                                              + (0x7fffffU 
                                                 & (fadd__DOT__mant_final_shifted 
                                                    >> 3U))));
        if ((0x800000U & vlSelf->fadd__DOT__frac_rounded)) {
            vlSelf->fadd__DOT__frac_final = 0U;
            vlSelf->fadd__DOT__exp_final = (0xffU & 
                                            ((IData)(1U) 
                                             + (IData)(vlSelf->fadd__DOT__s2_exp_reg)));
        } else {
            vlSelf->fadd__DOT__frac_final = (0x7fffffU 
                                             & vlSelf->fadd__DOT__frac_rounded);
            vlSelf->fadd__DOT__exp_final = vlSelf->fadd__DOT__s2_exp_reg;
        }
    } else {
        vlSelf->fadd__DOT__frac_final = (0x7fffffU 
                                         & (fadd__DOT__mant_final_shifted 
    ...
    vlSelf->fadd__DOT__c3_result_comb = (((IData)(vlSelf->fadd__DOT__s2_sign_reg) 
                                          << 0x1fU) 
                                         | (((IData)(vlSelf->fadd__DOT__exp_final) 
                                             << 0x17U) 
                                            | vlSelf->fadd__DOT__frac_final));
}
...
VL_ATTR_COLD void Vfadd___024root___ctor_var_reset(Vfadd___024root* vlSelf) {
    ...
    vlSelf->fadd__DOT__frac_final = VL_RAND_RESET_I(23);
    vlSelf->fadd__DOT__exp_final = VL_RAND_RESET_I(8);
    vlSelf->fadd__DOT__frac_rounded = VL_RAND_RESET_I(24);
    vlSelf->fadd__DOT__unnamedblk1__DOT__temp_shifted = VL_RAND_RESET_I(27);
