...
VL_ATTR_COLD void Vfsqrt___024root___eval_initial__TOP(Vfsqrt___024root* vlSelf) {
    ...
    __Vtemp_2[1U] = 0x61626c65U;
    __Vtemp_2[2U] = 0x73715f74U;
    __Vtemp_2[3U] = 0x7172745fU;
    __Vtemp_2[4U] = 0x6673U;
    VL_READMEM_N(true, 24, 1024, 0, VL_CVT_PACK_STR_NW(5, __Vtemp_2)
                 ,  &(vlSelf->fsqrt__DOT__lut_sq), 0
                 , ~0ULL);
}
