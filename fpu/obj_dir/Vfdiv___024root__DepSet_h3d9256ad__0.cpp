...
VL_INLINE_OPT void Vfdiv___024root___nba_sequent__TOP__0(Vfdiv___024root* vlSelf) {
    ...
    if (vlSelf->rst_n) {
        ...
        if (vlSelf->fdiv__DOT__st2_nan) {
            ...
            vlSelf->result = ((VL_LTS_III(10, 0xffU, (IData)(vlSelf->fdiv__DOT__st2_exponent)) 
                               | ((0xffU == (IData)(vlSelf->fdiv__DOT__st2_exponent)) 
                                  & (vlSelf->fdiv__DOT__st2_mantissa 
                                     >= vlSelf->fdiv__DOT__st2_mantissa_b)))
                               ? (0x7f800000U | ((IData)(vlSelf->fdiv__DOT__st2_sign) 
                                                 << 0x1fU))
                               : (VL_LTES_III(11, 0xffU, (IData)(vlSelf->fdiv__DOT__final_exp))
                                   ? (0x7f800000U | 
        ...
        vlSelf->fdiv__DOT__st2_mantissa_b = vlSelf->fdiv__DOT__st1_mantissa_b;
        vlSelf->fdiv__DOT__st2_exponent = vlSelf->fdiv__DOT__st1_exponent;
        vlSelf->fdiv__DOT__st2_mantissa = vlSelf->fdiv__DOT__st1_mantissa_a;
        vlSelf->fdiv__DOT__st1_mantissa_b = vlSelf->fdiv__DOT__m_b;
        vlSelf->fdiv__DOT__st1_exponent = (0x3ffU & 
                                           ((IData)(0x7fU) 
                                            + (((0U 
                                                 != 
                                                 (0xffU 
        ...
        vlSelf->fdiv__DOT__st2_mantissa_b = 0U;
        vlSelf->fdiv__DOT__st2_exponent = 0U;
