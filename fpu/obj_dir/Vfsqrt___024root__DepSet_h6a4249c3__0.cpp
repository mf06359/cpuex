...
VL_INLINE_OPT void Vfsqrt___024root___nba_sequent__TOP__0(Vfsqrt___024root* vlSelf) {
    ...
    if (vlSelf->rst_n) {
        vlSelf->fsqrt__DOT__valid_reg = ((0xeU & ((IData)(vlSelf->fsqrt__DOT__valid_reg) 
                                                  << 1U)) 
        ...
        __Vdly__fsqrt__DOT__is_abnormal_reg = ((6U 
                                               ...
                                               | (0xffU 
                                                  ...
                                                  (0xffU 
                                                   & (vlSelf->input_a 
                                                      >> 0x17U))));
        vlSelf->fsqrt__DOT__exp_final_reg = vlSelf->fsqrt__DOT__exp_reg;
        vlSelf->result = ((4U & (IData)(vlSelf->fsqrt__DOT__is_zero_reg))
                           ? ((IData)(vlSelf->fsqrt__DOT__sign_final_reg) 
                              << 0x1fU) : ((4U & (IData)(vlSelf->fsqrt__DOT__is_abnormal_reg))
                                            ? (0x7f800000U 
                                               | ((IData)(vlSelf->fsqrt__DOT__sign_final_reg) 
                                                  << 0x1fU))
                                            : (((IData)(vlSelf->fsqrt__DOT__sign_final_reg) 
        ...
        vlSelf->fsqrt__DOT__mul_reg = (0xffffffffffffULL 
        ...
        vlSelf->fsqrt__DOT__exp_final_reg = 0U;
        vlSelf->result = 0U;
        vlSelf->fsqrt__DOT__mul_reg = 0ULL;
    ...
    vlSelf->out_valid = (1U & ((IData)(vlSelf->fsqrt__DOT__valid_reg) 
                               >> 3U));
    vlSelf->fsqrt__DOT__sign_final_reg = ((IData)(vlSelf->rst_n) 
...
VL_INLINE_OPT void Vfsqrt___024root___nba_sequent__TOP__1(Vfsqrt___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vfsqrt__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vfsqrt___024root___nba_sequent__TOP__1\n"); );
    // Body
...
void Vfsqrt___024root___eval_nba(Vfsqrt___024root* vlSelf) {
    ...
    if ((2ULL & vlSelf->__VnbaTriggered.word(0U))) {
        Vfsqrt___024root___nba_sequent__TOP__1(vlSelf);
    }
}
