...
VL_ATTR_COLD void Vtop_fmul_sqrt___024root___eval_initial__TOP(Vtop_fmul_sqrt___024root* vlSelf) {
    ...
    VL_READMEM_N(true, 24, 1024, 0, VL_CVT_PACK_STR_NW(4, __Vtemp_1)
                 ...
                 , 0, ~0ULL);
    vlSelf->top_fmul_sqrt__DOT__u_fsqrt__DOT__unnamedblk1__DOT__i = 0U;
    while (VL_GTS_III(32, 0x400U, vlSelf->top_fmul_sqrt__DOT__u_fsqrt__DOT__unnamedblk1__DOT__i)) {
        vlSelf->top_fmul_sqrt__DOT__u_fsqrt__DOT__lut_sq[(0x3ffU 
                                                          & vlSelf->top_fmul_sqrt__DOT__u_fsqrt__DOT__unnamedblk1__DOT__i)] 
            = (0xffffffU & (IData)((0xffffffULL & (
                                                   ...
                                                   >> 0x18U))));
        vlSelf->top_fmul_sqrt__DOT__u_fsqrt__DOT__unnamedblk1__DOT__i 
            = ((IData)(1U) + vlSelf->top_fmul_sqrt__DOT__u_fsqrt__DOT__unnamedblk1__DOT__i);
    }
}
...
VL_ATTR_COLD void Vtop_fmul_sqrt___024root___ctor_var_reset(Vtop_fmul_sqrt___024root* vlSelf) {
    ...
    vlSelf->top_fmul_sqrt__DOT__u_fsqrt__DOT__unnamedblk1__DOT__i = 0;
